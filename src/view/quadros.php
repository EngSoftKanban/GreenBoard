...
<head>
    ...
    <link rel="stylesheet" href="../Css/quadros.css"> <!-- Caminho corrigido -->
    <style>
        #create-modal {
            display: none; 
            position: absolute; 
...
<body>
    <header>
        <div class="board-title">
            <img src="../resources/logo.png" alt="Logo GreenBoard" class="logo"> <!-- Caminho corrigido -->
            <h1>GreenBoard</h1>
        </div>
        <div class="user-avatar">
            <img src="../resources/user.png" alt="Usuário" class="user-icon"> <!-- Caminho corrigido -->
        </div>
    </header>
                ...
                <div>
                    ...
                    <?php else: ?>
                        <?php foreach ($recentes as $quadro): ?>
                            <div class="quadro">
                                <a href="/src/view/gerenciar_listas.php?quadro_id=<?php echo $quadro['id']; ?>"><?php echo $quadro['nome']; ?></a> <!-- Caminho mantido -->
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
                ...
                <div id="quadro-list">
                    ...
                    <?php else: ?>
                        <?php foreach ($quadros as $quadro): ?>
                            <div>
                                <a href="/src/view/gerenciar_listas.php?quadro_id=<?php echo $quadro['id']; ?>"><?php echo $quadro['nome']; ?></a>
                                <form action="../quadros_backend.php" method="POST" style="display:inline;" onsubmit="return confirm('Tem certeza que deseja remover esse quadro?');">
